...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="<?= base_url('pelanggan') ?>">
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; Kasir Brantas 2024</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
    ...
    <!-- FontAwesome Brands -->
    <script src="https://cdn.jsdelivr.net/npm/font-awesome-brand@1.0.0/font-awesome-brand.min.js"></script>
